...
export const dict = {
  ...
  "ava.agents.form.variant": "Model variant",
  "ava.agents.form.variant.placeholder": "Default",
  ...
  "ava.agents.form.reasoning.hint": "Passed through to the model provider when supported",
