...
export const dict = {
  ...
  "dialog.agent.manage": "Manage agents",
  ...
  "cacheTimer.remaining": "{{time}} remaining",
  ...
  "settings.ava.row.simplifySidePanel.description":
    "Replace Git review with a simple file browser: search files, read content, and browse other folders without changing the project.",
  "ava.sidePanel.files": "Files",
  "ava.sidePanel.backup": "Backup",
  "ava.sidePanel.tabs": "Side panel",
  "ava.sidePanel.context": "Context",
  "ava.sidePanel.agents": "Agents",
  "ava.sidePanel.instructions": "Instructions",
  ...
  "ava.sidePanel.copyToClipboard": "Copy contents to clipboard",
  "ava.sidePanel.copySuccess.title": "Copied contents to clipboard",
  "ava.sidePanel.copySuccess.description.one": "Copied {{count}} file to the clipboard.",
  ...
  "ava.gitGraph.title": "Backups",
  "ava.gitGraph.openRepository": "Open",
  "ava.gitGraph.openHint": "Paste the full path to a folder that contains a .git directory, then press Enter.",
  "ava.gitGraph.pathPlaceholder": "C:\\path\\to\\your\\project",
  "ava.gitGraph.empty": "No backups yet. Create one to get started.",
  "ava.gitGraph.unborn": "No backups yet. Create one to get started.",
  "ava.gitGraph.invalid": "This folder has no Git repository. Would you like to make one?",
  "ava.gitGraph.loading": "Loading backups…",
  "ava.gitGraph.error": "Could not read git history",
  "ava.gitGraph.stale": "History may be out of date",
  "ava.gitGraph.unsupported": "Repository type is unsupported",
  "ava.gitGraph.selectRepository": "Choose a repository to visualize",
  "ava.gitGraph.noSelection": "Select a backup",
  "ava.gitGraph.detachedHead": "You are here, with no branch name",
  "ava.gitGraph.pathSameThread": "Same branch",
  "ava.gitGraph.pathFork": "Branch off",
  "ava.gitGraph.pathMerge": "Merge",
  "ava.gitGraph.pathGrewFrom": "grew from",
  "ava.gitGraph.pathBranchedOff": "branched off",
  "ava.gitGraph.pathJoined": "joined",
  "ava.gitGraph.branchOff": "Create branch",
  "ava.gitGraph.restoreBackup": "Restore backup",
  "ava.gitGraph.mergeBackups": "Squash",
  "ava.gitGraph.mergeName": "Squashed backup name",
  "ava.gitGraph.mergeHint": "Click consecutive backups on this branch, then Squash.",
  "ava.gitGraph.confirmMerge": "Squash these backups into one? This cannot be undone from here.",
  "ava.gitGraph.confirmMergeTitle": "Squash backups",
  "ava.gitGraph.moveBranchTo": "Move branch to",
  "ava.gitGraph.confirmMove": "Move this branch to sit on top of another branch, instead of where it currently is.",
  "ava.gitGraph.moveChoose": "Choose another branch to move this to.",
  "ava.gitGraph.moveNeedsName": "In order to move this branch, you need to give it a name.",
  "ava.gitGraph.conflictEditHint": "Edit the files, then click Done.",
  "ava.gitGraph.deleteBackup": "Delete",
  "ava.gitGraph.confirmDelete": "Delete this backup? You will land on the backup before it.",
  "ava.gitGraph.confirmDeleteLater":
    "This backup and every newer one on this branch will be deleted. You will land on the backup before this.",
  "ava.gitGraph.createThread": "Create",
  "ava.gitGraph.threadName": "Branch name",
  "ava.gitGraph.cancel": "Cancel",
  "ava.gitGraph.createBackup": "Create backup",
  "ava.gitGraph.savingBackup": "Saving backup…",
  "ava.gitGraph.backupName": "Backup name",
  "ava.gitGraph.backupCloud": "Cloud",
  "ava.gitGraph.backupDisk": "Disk",
  "ava.gitGraph.goToHead": "Go to most recent backup",
  "ava.gitGraph.noBranch": "No branch name",
  ...
  "ava.gitGraph.changeColor": "Change color",
  "ava.gitGraph.pushAllToCloud": "Push all backups to cloud",
  "ava.gitGraph.pushingCloud": "Pushing backups to cloud…",
  "ava.gitGraph.searchBackups": "Search backups",
  "ava.gitGraph.searchPlaceholder": "Search for a backup...",
  "ava.agents.tab": "Agents",
  "ava.agents.section.agents": "Agents",
  "ava.agents.section.instructions": "Instructions",
  "ava.agents.scope.project": "This project",
  "ava.agents.scope.global": "Global",
  "ava.agents.empty.agent": "Select an agent",
  "ava.agents.empty.instruction": "Select an instruction",
  "ava.agents.new.agent": "New agent",
  "ava.agents.new.instruction": "New instruction",
  "ava.agents.delete": "Delete",
  "ava.agents.delete.title.agent": "Delete agent",
  "ava.agents.delete.title.instruction": "Delete instruction",
  "ava.agents.delete.confirm.agent": 'Delete "{{name}}"? It will be moved to the trash.',
  "ava.agents.delete.confirm.instruction": 'Delete "{{name}}"? It will be moved to the trash.',
  "ava.agents.instruction.project": "Project",
  "ava.agents.instruction.personal": "Personal",
  ...
  "ava.agents.search.clear": "Clear search",
  "ava.agents.form.instructions": "Instructions",
  "ava.agents.form.editDocument": "Edit document",
  "ava.agents.form.showSettings": "Show settings",
  "ava.agents.form.instructions.add": "Add instruction",
  "ava.agents.form.instructions.remove": "Remove instruction",
  ...
  "ava.agents.form.role": "Role",
  "ava.agents.form.role.chat": "Chat",
  "ava.agents.form.role.helper": "Helper",
  "ava.agents.form.role.both": "Both",
  "ava.agents.form.model": "Model",
  "ava.agents.form.model.hint": "provider/model, like anthropic/claude-sonnet-4-5",
  "ava.agents.form.model.placeholder": "Leave blank to use the session model",
  "ava.agents.form.model.search": "Search models...",
  "ava.agents.form.model.empty": "No matching models",
  "ava.agents.form.temperature": "Temperature",
  "ava.agents.form.topP": "Top P",
  "ava.agents.form.steps": "Max steps",
  "ava.agents.form.steps.placeholder": "(leave this if you want it unlimited)",
  "ava.agents.form.steps.hint": "Leave empty for unlimited. A number caps tool rounds before the agent must stop.",
  "ava.agents.form.color": "Color",
  "ava.agents.form.color.hint": "Hex like #4C6FFF, or a theme name like primary",
  "ava.agents.form.color.clear": "Clear",
  "ava.agents.form.reasoning": "Reasoning effort",
  "ava.agents.form.reasoning.hint": "Uses this model's effort presets when it has them. Otherwise a generic setting the provider may support.",
  "ava.agents.form.reasoning.minimal": "Minimal",
  "ava.agents.form.reasoning.low": "Low",
  "ava.agents.form.reasoning.medium": "Medium",
  "ava.agents.form.reasoning.high": "High",
  "ava.agents.form.default": "Default",
  "ava.agents.form.disable": "Disable agent",
  "ava.agents.form.disable.hint": "This agent will not appear or run until you turn it back on.",
  "ava.agents.form.hidden": "Hide from @ menu",
  "ava.agents.form.permissions": "Permissions",
  "ava.agents.form.action.allow": "Allow",
  "ava.agents.form.action.ask": "Ask",
  "ava.agents.form.action.deny": "Deny",
  "ava.agents.form.permission.read": "Read files",
  "ava.agents.form.permission.edit": "Edit files",
  "ava.agents.form.permission.glob": "Find by name",
  "ava.agents.form.permission.grep": "Search in files",
  "ava.agents.form.permission.list": "List folders",
  "ava.agents.form.permission.bash": "Terminal",
  "ava.agents.form.permission.outside": "Outside project",
  "ava.agents.form.permission.todos": "Task list",
  "ava.agents.form.permission.question": "Ask you questions",
  "ava.agents.form.permission.webfetch": "Fetch web pages",
  "ava.agents.form.permission.websearch": "Web search",
  "ava.agents.form.permission.lsp": "Language server",
  "ava.agents.form.permission.loop": "Repeat-loop guard",
  "ava.agents.form.permission.skill": "Skills",
  "ava.agents.form.taskDefault": "Spawning other agents",
  "ava.agents.form.taskDefault.hint": "Default when this agent starts another agent",
  "ava.agents.form.taskAgents": "Helper agents",
  "ava.agents.form.taskAgents.name": "Agent name",
  "ava.agents.form.taskAgents.add": "Add helper agent",
  "ava.agents.form.taskAgents.remove": "Remove helper agent",
