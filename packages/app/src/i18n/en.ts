...
export const dict = {
  ...
  "ava.agents.form.instructions.none": "No shared instructions yet",
  ...
  "ava.agents.form.steps.hint": "How many tool rounds before the agent must stop",
  ...
  "ava.agents.form.disable": "Disabled",
