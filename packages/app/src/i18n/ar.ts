export const dict = {
  ...
  "settings.ava.row.layer.frame.description": "Title bar, window edge, and the darkest chrome behind tabs and window controls.",
  ...
  "settings.ava.row.layer.wells.description": "Markdown code blocks and the terminal, separately from the rest of the UI.",
  ...
  "ava.sidePanel.copySuccess.description.zero": "Copied {{count}} files to the clipboard.",
  "ava.sidePanel.copySuccess.description.two": "Copied {{count}} files to the clipboard.",
  "ava.sidePanel.copySuccess.description.few": "Copied {{count}} files to the clipboard.",
  "ava.sidePanel.copySuccess.description.many": "Copied {{count}} files to the clipboard.",
